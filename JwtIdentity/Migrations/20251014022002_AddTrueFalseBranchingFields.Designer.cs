...
namespace JwtIdentity.Migrations
{
    ...
    [Migration("20251014022002_AddTrueFalseBranchingFields")]
    partial class AddTrueFalseBranchingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JwtIdentity.Models.ChoiceOption", b =>
                {
                    ...
                    b.Property<int?>("BranchToGroupId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SelectAllThatApplyQuestionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JwtIdentity.Models.PlaywrightLog", b =>
                {
                    ...
                    b.Property<string>("FailedElement")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("JwtIdentity.Models.QuestionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("NextGroupId")
                        .HasColumnType("int");

                    b.Property<bool>("SubmitAfterGroup")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JwtIdentity.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JwtIdentity.Models.Survey", b =>
                {
                    ...
                    b.Property<bool>("AiQuestionsApproved")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JwtIdentity.Models.SurveyAnalysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JwtIdentity.Models.Rating1To10Answer", b =>
                {
                    b.HasBaseType("JwtIdentity.Models.Answer");
            ...
            modelBuilder.Entity("JwtIdentity.Models.SelectAllThatApplyAnswer", b =>
                {
                    b.HasBaseType("JwtIdentity.Models.Answer");
            ...
            modelBuilder.Entity("JwtIdentity.Models.Rating1To10Question", b =>
                {
                    b.HasBaseType("JwtIdentity.Models.Question");
            ...
            modelBuilder.Entity("JwtIdentity.Models.SelectAllThatApplyQuestion", b =>
                {
                    b.HasBaseType("JwtIdentity.Models.Question");
            ...
            modelBuilder.Entity("JwtIdentity.Models.TrueFalseQuestion", b =>
                {
                    ...
                    b.Property<int?>("BranchToGroupIdOnFalse")
                        .HasColumnType("int");

                    b.Property<int?>("BranchToGroupIdOnTrue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JwtIdentity.Models.QuestionGroup", b =>
                {
                    ...
                    b.HasOne("JwtIdentity.Models.Survey", "Survey")
