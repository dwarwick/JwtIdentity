...
{
    public class SurveysIAnsweredModel : BlazorBase, IBrowserViewportObserver, IAsyncDisposable
    {
        [Inject]
        ...
        {
            UserSurveys = (await ApiService.GetAllAsync<SurveyViewModel>("api/Survey/surveysianswered")).ToList();
        }
